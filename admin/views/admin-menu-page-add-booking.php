...
<div class="wrap">
    ...
    <form method="post" class="add-booking-form" action="<?php echo esc_html(admin_url('admin-post.php')); ?>">
        ...
        <input type="submit" value="<?php echo $edit_mode ? 'Update Booking' : 'Add Booking'; ?>">
        <?php if ($edit_mode) echo '<input type="hidden" name="id" value="' . $id . '">'; // Add a hidden input field with the booking ID in edit mode. 
        ?>
    </form>
</div>